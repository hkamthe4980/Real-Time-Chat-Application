...
// const ChatProfile = ({ conversation }) => {
...
//     },
//     {
//       action: 'Viewed performance report',
//       time: '1 day ago'
//     },
//     {
//       action: 'Achieved personal best',
//       time: '3 days ago'
//     }
//   ];
...
//     {
//       name: "You",
//       avatar: "https://ui-avatars.com/api/?name=Push&background=ED709F&color=FFFFFF&size=32"
//     },
//     {
//       name: "Shankar",
//       avatar: "https://ui-avatars.com/api/?name=Shankar&background=6B7280&color=FFFFFF&size=32"
//     },
//     {
//       name: "Ehsaan",
//       avatar: "https://ui-avatars.com/api/?name=Ehsaan&background=52D137&color=FFFFFF&size=32"
//     },
//     {
//       name: "Loy",
//       avatar: "https://ui-avatars.com/api/?name=Loy&background=3A70C2&color=FFFFFF&size=32"
//     },
//     {
//       name: "Her's",
//       avatar: "https://ui-avatars.com/api/?name=Hers&background=6B7280&color=FFFFFF&size=32"
//     },
//     {
//       name: "Djo",
//       avatar: "https://ui-avatars.com/api/?name=Djo&background=CA7271&color=FFFFFF&size=32"
//     },
//     {
//       name: "Clairo",
//       avatar: "https://ui-avatars.com/api/?nameclario&background=6B7280&color=FFFFFF&size=32"
//     },
//     {
//       name: "Trivedi",
//       avatar: "https://ui-avatars.com/api/?name=Trivedi&background=971C1C&color=FFFFFF&size=32"
//     },
//   ]
...
//           />
//           <h3 className="text-xl font-semibold text-black mb-1">{conversation.name}</h3>
//           <p className="text-base text-gray-700 mb-2">
//             {conversation.isGroup ? `${conversation.memberCount} members` : 'Forward • athletics Team A'}
//           </p>
...
//               </>
//             ) : (
//               <span>Last seen: {conversation.lastSeen || 'Offline'}</span>
//             )}
//           </div>
//         </div>
...
//               <div key={index} className="flex items-center gap-3 py-2 hover:bg-gray-50 rounded-lg px-2 transition-colors">
//                 <img src={member.avatar} alt={member.name} className='w-10 h-10 rounded-full object-cover flex-shrink-0 border border-gray-300'/>
          ...
          <div className="space-y-2">
            ...
            {(members.length > 0) ? members.map((member, index) => (
              <div key={member._id || index} className="flex items-center gap-3 py-2 hover:bg-gray-50 rounded-lg px-2 transition-colors">
                ...
                <p className='text-base text-black font-medium'>{member.name}</p>
                <p className={member.isOnline ? 'text-sm text-emerald-500' : 'text-sm text-gray-300'}>
