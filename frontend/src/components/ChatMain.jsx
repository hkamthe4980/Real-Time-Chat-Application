...
const ChatMain = ({
        ...
        return (
            ...
            >
                ...
                <div className="max-w-[75%] relative  group flex items-center gap-2">
                    ...
                    <div
                        className={`relative rounded-2xl px-2 pr-2 pb-2 pt-2 shadow-sm border group ${type === "received"
    ...
    const renderTextMessage = (message, type, avatarUrl) => {
        ...
        if (type === "received") {
            return (
                <div key={msgId} className="flex items-start space-x-2 mb-3">
                    {/* Avatar */}
                    <img
                        src={avatarUrl}
                        alt={senderName}
                    ...
                    <div className="max-w-[75%] relative ">
                        {/* ⭐ Reaction Popup */}
                        {activeReactionFor === msgId && <ReactionPopup messageId={msgId} />}
        ...
        return (
            ...
            >
                ...
                <div className="max-w-[75%] relative">
                    ...
                    {/* Bubble with handlers */}
                    <div
                        className={`relative rounded-2xl px-2 pr-2 pb-2 pt-2 shadow-sm border flex items-center space-x-2 group ${isSent
                            ? "bg-black text-white border-black rounded-br-sm"
    ...
    return (
        <div>
            ...
            <div
                ...
                className={`h-full px-4 sm:px-6 pt-0 pb-4 bg-gray-50 scrollbar-hide ${disableScroll ? "overflow-hidden" : "overflow-y-auto"
                    }`}
            >
